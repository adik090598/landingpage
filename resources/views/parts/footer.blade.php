    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-9">
                <ul class="footer-ul d-flex align-items-start justify-content-end">
                    ...
                    <li class="col-4 col-md-3">
                        <div class="d-flex flex-column">
                            ...
                            <p class="footer-text">View our terms and conditions</p>
                            <div class="social-networks d-flex justify-content-between align-items-center">
